...
public class ChallengeDbContext : DbContext
{
    ...
    public DbSet<BookChallenge> ChallengeBooks { get; set; } = null!;
   ...
   protected override void OnModelCreating(ModelBuilder modelBuilder)
   {
      ...
      modelBuilder.Entity<Book>().HasData(
        new Book { Id = 1, Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", 
                   ...
                   Genre = "Classic", Year = 1925, Language = "English", Pages = "180"},
        
        new Book { Id = 2, Title = "The Secret Life of Bees", Author = "Sue Monk Kidd",
                   ...
                   Genre = "Fiction", Year = 2001, Language = "English", Pages = "302"},

        new Book { Id = 3, Title = "The Vacationers", Author = "Emma Straub", 
                   ...
                   Genre = "Fiction", Year = 2014, Language = "English", Pages = "292"},

        new Book { Id = 4, Title = "The Night Circus", Author = "Erin Morgenstern",
                   ...
                   Genre = "Fiction", Year = 2011, Language = "English", Pages = "506"},
                   
        new Book { Id = 5, Title = "The Secret History", Author = "Donna Tartt",
                   ...
                   Genre = "Classic", Year = 1992,  Language = "English", Pages = "559"});

     modelBuilder.Entity<BookChallenge>().HasData(
        new BookChallenge { Id = 1, BookId = 1, ChallengeId = 1 },
        new BookChallenge { Id = 2, BookId = 2, ChallengeId = 1 },
        new BookChallenge { Id = 3, BookId = 3, ChallengeId = 1 },
        new BookChallenge { Id = 4, BookId = 4, ChallengeId = 2 },
        new BookChallenge { Id = 5, BookId = 5, ChallengeId = 2 });
